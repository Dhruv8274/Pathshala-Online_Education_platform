...
<article className="cards">
          ...
          <div className="cards__content | flow">
            <div className="cards__content--container | flow">
              <h2 className="cards__title"style={{color:'White'}}>12th Video lecture</h2>
              <p className="cards__description"style={{color:'White'}}>
...
<article className="cards">
          ...
          <div className="cards__content | flow">
            <div className="cards__content--container | flow">
              <h2 className="cards__title"style={{color:'White'}}>10th Vedio Lectutre</h2>
              <p className="cards__description"style={{color:'White'}}>
              Render all the vedio of important topics and all subjects.
              </p>
            </div>
...
<article className="cards">
          ...
          <div className="cards__content | flow">
            <div className="cards__content--container | flow">
              <h2 className="cards__title"style={{color:'White'}}>9th Video Lectures</h2>
              <p className="cards__description"style={{color:'White'}}>
              Render all the vedio of important topics and all subjects.
              </p>
            </div>
