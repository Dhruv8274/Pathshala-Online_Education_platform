          ...
          <ul>
            ...
            <li className="pracheading">
                <div className="pracheading2" >
                    <h1 className="generalheading">Class 9th Subject </h1>
                </div>
            </li>
          </ul>
        </div>
          ...
          <ul className="nav-menu">
            ...
            >
              <a href="/">
                ...
                <span className="menu-text">9th English</span>
              </a>
            </li>
            <li
            ...
            >
              <a href="/">
                ...
                <span className="menu-text">9th Hindi</span>
              </a>
            </li>
            <li
            ...
            >
              <a href="/">
                ...
                <span className="menu-text">9th Mathematics</span>
              </a>
            </li>
            <li
            ...
            >
              <a href="/">
                ...
                <span className="menu-text">9th Science</span>
              </a>
            </li>
            <li
            ...
            >
              <a href="/">
                ...
                <span className="menu-text">9th SocialScience</span>
              </a>
            </li>
        </ul>
