          ...
          <ul>
            ...
            <li className="pracheading">
                <div className="pracheading2" >
                    <h1 className="generalheading">Class 10th Famous Books</h1>
                </div>
            </li>
          </ul>
        </div>
          ...
          <ul className="nav-menu">
            ...
            >
              <a href="/">
                ...
                <span className="menu-text">R.D Sharma</span>
              </a>
            </li>
            <li
            ...
            >
              <a href="/">
                ...
                <span className="menu-text">R.S Aggarwal</span>
              </a>
            </li>
